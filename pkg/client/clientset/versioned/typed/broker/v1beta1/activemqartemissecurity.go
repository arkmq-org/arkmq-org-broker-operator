...
import (
	...
	v1beta1 "github.com/arkmq-org/activemq-artemis-operator/v2/api/v1beta1"
	scheme "github.com/arkmq-org/activemq-artemis-operator/v2/pkg/client/clientset/versioned/scheme"
...
type ActiveMQArtemisSecurityInterface interface {
	Create(*v1beta1.ActiveMQArtemisSecurity) (*v1beta1.ActiveMQArtemisSecurity, error)
	Update(*v1beta1.ActiveMQArtemisSecurity) (*v1beta1.ActiveMQArtemisSecurity, error)
	UpdateStatus(*v1beta1.ActiveMQArtemisSecurity) (*v1beta1.ActiveMQArtemisSecurity, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.ActiveMQArtemisSecurity, error)
	List(opts v1.ListOptions) (*v1beta1.ActiveMQArtemisSecurityList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ActiveMQArtemisSecurity, err error)
...
func newActiveMQArtemisSecurities(c *BrokerV1beta1Client, namespace string) *activeMQArtemisSecurities {
...
func (c *activeMQArtemisSecurities) Get(name string, options v1.GetOptions) (result *v1beta1.ActiveMQArtemisSecurity, err error) {
	result = &v1beta1.ActiveMQArtemisSecurity{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *activeMQArtemisSecurities) List(opts v1.ListOptions) (result *v1beta1.ActiveMQArtemisSecurityList, err error) {
	result = &v1beta1.ActiveMQArtemisSecurityList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("activemqartemissecurities").
...
func (c *activeMQArtemisSecurities) Create(activeMQArtemisSecurity *v1beta1.ActiveMQArtemisSecurity) (result *v1beta1.ActiveMQArtemisSecurity, err error) {
	result = &v1beta1.ActiveMQArtemisSecurity{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("activemqartemissecurities").
...
func (c *activeMQArtemisSecurities) Update(activeMQArtemisSecurity *v1beta1.ActiveMQArtemisSecurity) (result *v1beta1.ActiveMQArtemisSecurity, err error) {
	result = &v1beta1.ActiveMQArtemisSecurity{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("activemqartemissecurities").
...
func (c *activeMQArtemisSecurities) UpdateStatus(activeMQArtemisSecurity *v1beta1.ActiveMQArtemisSecurity) (result *v1beta1.ActiveMQArtemisSecurity, err error) {
	result = &v1beta1.ActiveMQArtemisSecurity{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("activemqartemissecurities").
...
func (c *activeMQArtemisSecurities) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ActiveMQArtemisSecurity, err error) {
	result = &v1beta1.ActiveMQArtemisSecurity{}
